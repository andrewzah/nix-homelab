...
# to /etc/nixos/configuration.nix instead.
{
  ...
  boot.kernelPatches = [
    ...
    # can be removed when using kernel 6.17 AFAICT
    {
  ...
  fileSystems."/" = {
    device = "/dev/disk/by-uuid/1e942b40-4d37-440e-8bbd-661d063ad55a";
    fsType = "ext4";
  };

  fileSystems."/boot" = {
    device = "/dev/disk/by-uuid/FBEA-EDAC";
    fsType = "vfat";
    options = ["fmask=0077" "dmask=0077"];
  };

  swapDevices = [
    {device = "/dev/disk/by-uuid/a87a46c6-4cf7-4e34-8598-18b5c81e81d1";}
  ];
